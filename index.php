...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        ...
        <h1 class="my-content">Welcome to Study Point</h1>
        <small class="my-content">Learn anytime and anywhere</small><br />
        <small class="my-content">Affordable online courses for everyone</small><br/>
        <?php    
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-users mr-3"></i> Best Instructors</h5>
          </div>
          <div class="col-sm">
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.facebook.com/neeraj.ravipratap/"><i class="fab fa-facebook-f"></i> Facebook</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="https://twitter.com/i/flow/login?redirect_after_login=%2F"><i class="fab fa-twitter"></i> Twitter</a>
          </div>
          <div class="col-sm">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Study Point Provides best content which helps to cracking your coding Interviews.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="https://www.simplilearn.com/pgp-full-stack-web-development-certification-training-course">Web Development</a><br />
            <a class="text-dark" href="https://www.udemy.com/course/introduction-to-modern-web-architecture/">Web Designing</a><br />
            <a class="text-dark" href="https://www.udemy.com/topic/android-development/">Android App Dev</a><br />
            <a class="text-dark" href="https://www.udemy.com/course/ios-13-app-development-bootcamp/">iOS Development</a><br />
            <a class="text-dark" href="https://www.coursera.org/browse/data-science/data-analysis">Data Analysis</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Study Point <br> Kormangala <br> Bengaluru <br> Mob.no 8478479233 </p>
          </div>
        </div>
      </div>
